<template>
  <div>
    ...
    <div style="display: flex; justify-self:center; align-items: center; margin-bottom: 20px">
      <el-table v-loading="process" :data="tableData"
        border
        style="width: 85%;">
        <el-table-column
          prop="id"
...
export default {
  ...
  data() {
    return {
      ...
      options1: [
        { value: 'gpr_feature_table', label: 'Gaussian Process Regression' },
        { value: 'knn_feature_table', label: 'K-Nearest Neighbors' },
        { value: 'mlr_feature_table', label: 'Multiple Linear Regression' },
        { value: 'svr_feature_table', label: 'Support Vector Regression' }
      ],
      tableData: [], // 表格数据
      total: 0, // 数据总数
      currentPage: 1, // 当前页码
