...
export default {
  ...
  data(){
    return {
      ...
      options1: [
        { value: 'gpr_kernel', label: 'Gaussian Process Regression' },
        { value: 'knn_kernel', label: 'K-Nearest Neighbors' },
        { value: 'mlr_kernel', label: 'Multiple Linear Regression' },
        { value: 'svr_kernel', label: 'Support Vector Regression' }
      ],
  }
  },
  mounted() {
