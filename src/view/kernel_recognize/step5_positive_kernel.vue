...
export default {
  ...
  data(){
    return {
      ...
      options1: [
        { value: 'gpr_positive_kernel', label: 'Gaussian Process Regression' },
        { value: 'knn_positive_kernel', label: 'K-Nearest Neighbors' },
        { value: 'mlr_positive_kernel', label: 'Multiple Linear Regression' },
        { value: 'svr_positive_kernel', label: 'Support Vector Regression' }
      ],
    }
  },
  mounted() {
